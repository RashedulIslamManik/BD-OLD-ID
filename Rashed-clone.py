...
print("this tool is free by Rashed")

print

psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY RASHED-KING-OF-DEVIL.....................................OPENING.............')
...
def menu():
    ...
    print'FB OLD ID CLONING [RASHED]'

    print 50* '-'

    print 'Codder.  : RASHEDUL ISLAM MANIK'

    print 'AUTHOR   : RASHEDUL ISLAM MANIK'

    print 'FACEBOOK : https://www.facebook.com/Rashed.innocent.devil'

    print 'GITHUB   : https://github.com/RashedulIslamManik'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[RASHED-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(MAMUN)Open After 03 Days]\x1b[0m \n'
